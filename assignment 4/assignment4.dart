...
//    Task 13
 ...
 //   var larValue = unsortedList[0];
 //   var smalValue = unsortedList[0];
 //   for (var i = 0; i < unsortedList .length; i++) {     
 //     if (unsortedList[i] > larValue) {
 //       larValue = unsortedList[i];
 //     }     
 //     if (unsortedList[i] < smaltValue) {
 //       smalValue = unsortedList[i];
 //     }
 //   }
  //   print("Largest value  : $larValue");
 //   print("Smallest value t : $smalValue");
